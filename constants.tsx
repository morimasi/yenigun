  ...
  clinical_logic: [
    {
      ...
      weightedOptions: [
        { label: 'Hijyen ve konfor önceliklidir; hemen müdahale eder, çocuğun yüzünü temizler ve sakinleşince derse dönerim.', weights: { clinical: -0.6, empathy: 1.0, sustainability: -0.2 }, analysisInsight: 'Şefkat Tuzağı: Davranış anında fiziksel temas ve ilgi (temizlik) sağlayarak problem davranışı yanlışlıkla pekiştirme (Accidental Reinforcement) riski.' },
        { label: 'Kafasını korumak için el yastığı yaparım ama göz teması kurmadan, nötr bir yüzle krizin sönmesini bekler, temizliği kriz tamamen bitince yaparım.', weights: { clinical: 1.0, empathy: 0.2, sustainability: 0.8 }, analysisInsight: 'Klinik Sadakat: Güvenliği sağlarken "İlgi Çekme" veya "Kaçış" işlevini beslememe disiplini. (Planned Ignoring + Safety).' },
        { label: '"Yapma oğlum" diyerek çocuğu tutarım ve sakinleştirmeye çalışırım.', weights: { clinical: -0.8, empathy: 0.2, sustainability: -0.5 }, analysisInsight: 'Veri Kirliliği: Sözel uyaran vererek davranışı besleme (Social Attention) hatası.' },
        { label: 'Dersi o an sonlandırır, veliye çocuğu temizlemesi için teslim ederim.', weights: { clinical: -1.0, empathy: -0.5, institutionalLoyalty: -0.5 }, analysisInsight: 'Kaçınma Davranışı: Terapistin kriz anında otoriteyi ve sorumluluğu terk etmesi.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Güvenlik her şeyden önemlidir. Önce "Otur" derim, düzgün oturunca "Aferin" der ve ödülü veririm.', weights: { clinical: -0.4, pedagogicalAnalysis: -0.5, sustainability: 0.5 }, analysisInsight: 'Zamanlama Hatası: Hedef davranış (Konuşma) ile pekiştireç arasına "Oturma" talebi sokarak öğrenmeyi bozma (Blocking Effect).' },
        { label: 'Hiç beklemeden coşkuyla ödülü veririm; o an düşme riskini göze alırım çünkü "Su" demesi benim için altın değerindedir.', weights: { clinical: 1.0, pedagogicalAnalysis: 1.0, formality: -0.3 }, analysisInsight: 'Öncelik Yönetimi: Kritik beceriyi yakalamak için ikincil riskleri (kontrollü şekilde) yönetme zekası. (Catching the moment).' },
        { label: 'Görmezden gelirim, her şey mükemmel olmadan (hem oturuş hem konuşma) ödül verilirse yanlış davranış pekişir.', weights: { clinical: -0.7, empathy: -0.5, pedagogicalAnalysis: -0.8 }, analysisInsight: 'Mükemmeliyetçilik Tuzağı: Fırsat öğretimini kaçırma ve sönmeye sebep olma.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Akışı bozmam, 5-10 dakika uzatırım. Eğitimdeki bu an, dışarıdaki velinin beklemesinden daha değerlidir.', weights: { clinical: 0.6, ethics: -0.4, institutionalLoyalty: -0.5 }, analysisInsight: 'Sınır İhlali (Time Boundary): İyi niyetli ama kurumsal zaman yönetimini ve diğer ailenin hakkını ihlal eden eylem.' },
        { label: 'Tam dakikasında keserim. Kurallar kuraldır, diğer öğrencinin hakkına giremem.', weights: { clinical: -0.3, formality: 1.0, empathy: -0.2 }, analysisInsight: 'Mekanik Uygulama: Pedagojik kazancı prosedüre kurban etme.' },
        { label: 'Mevcut akışı "en yüksek noktada" (Peak) sonlandırıp, çocuğun "başarma hissiyle" ve tadı damağında kalarak çıkmasını sağlarım.', weights: { clinical: 1.0, pedagogicalAnalysis: 0.8, institutionalLoyalty: 0.8 }, analysisInsight: 'Pedagojik Ustalık: Kısıtlılığı avantaja çevirme (Leave them wanting more) ve kurumsal düzene uyum.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Ver onu bana, yoksa ders biter!" diye net bir sınır koyarım.', weights: { pedagogicalAnalysis: -0.4, empathy: -0.6, clinical: -0.2 }, analysisInsight: 'Güç Savaşı (Power Struggle): Çocuğu savunmaya iten ve ilişkiyi zedeleyen eski ekol yaklaşımı.' },
        { label: 'Elindeki oyuncağın "eksik parçasını" (örn: arabanın yolu, bebeğin biberonu) elimde tutup, oyunu devam ettirmek için bana muhtaç olmasını (Motivasyonel Operasyon) sağlarım.', weights: { pedagogicalAnalysis: 1.0, clinical: 0.9, empathy: 0.5 }, analysisInsight: 'Ortam Kontrolü (Environmental Control): Fiziksel güç yerine motivasyonel kontrol ve zeka kullanımı.' },
        { label: 'Bırakırım oynasın, yeter ki ağlamasın, sonra ikna ederim.', weights: { clinical: -0.6, sustainability: -0.4, workEthics: -0.3 }, analysisInsight: 'Teslimiyet: Terapötik liderliğin kaybı ve çocuğa kontrolü verme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Veri tutmam, aklımda tutarım, seanstan sonra hatırlar yazarım.', weights: { clinical: -0.6, workEthics: -0.4 }, analysisInsight: 'Hafıza Yanılgısı: Subjektif veri riski ve profesyonel ihmal.' },
        { label: 'Seansı iptal eder veya çocuğu bırakıp kağıdı aramaya giderim.', weights: { clinical: -0.3, institutionalLoyalty: -0.5 }, analysisInsight: 'Operasyonel Aksama: Çözüm odaklı olmama ve zaman kaybı.' },
        { label: 'Hemen bir boş kağıda, peçeteye veya elime "Tally" (çentik) atarak geçici bir kayıt sistemi kurarım. Verisiz seans olmaz.', weights: { clinical: 1.0, sustainability: 0.8, workEthics: 0.9 }, analysisInsight: 'Klinik Refleks: Şartlar ne olursa olsun veriye sadakat ve çözüm üretme.' }
      ]
    },
    // YENİ EKLENEN: KLİNİK YETERLİLİK & PEDAGOJİK ALTYAPI (10+10 = 20 SORU)
    {
      ...
      weightedOptions: [
        { label: '"Bu konuşma değil, anlamsız papağan tekrarı" diyerek net konuşurum.', weights: { clinical: 0.5, empathy: -0.8 }, analysisInsight: 'Kaba Gerçekçilik: Aileyi demoralize etme riski.' },
        { label: '"Evet, konuşması harika!" diyerek ailenin moralini bozmam.', weights: { clinical: -1.0, ethics: -0.8 }, analysisInsight: 'Profesyonel Yalan: Gelişimi sabote eden yanıltıcı bilgi.' },
        { label: '"Ses çıkarması harika bir başlangıç. Şimdi bu sesleri "iletişimsel amaca" (fonksiyonel) dönüştürmek için çalışacağız" diyerek çerçeveyi değiştiririm.', weights: { clinical: 1.0, empathy: 1.0 }, analysisInsight: 'Klinik Diplomasisi: Pozitifi koruyarak bilimsel hedefe yönlendirme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Çocuğa "Neden atıyorsun?" diye sorarım.', weights: { clinical: -0.5 }, analysisInsight: 'Bilişsel Hata: Sözel olmayan çocuktan içgörü bekleme.' },
        { label: 'Ona kızdığımda (dikkat verdiğimde) artıyor mu, yoksa ben yokken de (sesi duymak için) atıyor mu diye test ederim (Fonksiyonel Analiz).', weights: { clinical: 1.0, pedagogicalAnalysis: 1.0 }, analysisInsight: 'Bilimsel Gözlem: Davranışın işlevini test etme yetisi.' },
        { label: 'Farketmez, her türlü engellerim.', weights: { clinical: -0.2, pedagogicalAnalysis: -0.5 }, analysisInsight: 'Yüzeysel Müdahale.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Veliye saygı duyar, çocuğu uyuturum.', weights: { clinical: -0.8, institutionalLoyalty: -0.5 }, analysisInsight: 'Pasif Bakıcılık: Kurumun eğitim misyonunu ihlal.' },
        { label: 'Çocuğun yüzünü yıkar, hareketli aktivitelerle uyarılmasını sağlarım. Burası okul, uyuma yeri değil.', weights: { clinical: 1.0, sustainability: 0.5 }, analysisInsight: 'Profesyonel Duruş: Eğitimin sürekliliğini sağlama.' },
        { label: 'Dersi iptal ederim.', weights: { clinical: -0.5 }, analysisInsight: 'Kaçış.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Evet, bildi.', weights: { pedagogicalAnalysis: -0.8 }, analysisInsight: 'Hatalı Öğretim: Şans faktörünü (50/50 bile değil, %100) eleyememe.' },
        { label: 'Hayır, masaya "Mavi" (Çeldirici) koyup ayırt etmesini (Discrimination) sağlamadan öğrenme gerçekleşmiş sayılmaz.', weights: { pedagogicalAnalysis: 1.0, clinical: 0.8 }, analysisInsight: 'Ayırt Etme Öğretimi: Gerçek öğrenme kriteri.' },
        { label: 'Kırmızı elma da göstermeliyim.', weights: { pedagogicalAnalysis: 0.2 }, analysisInsight: 'Genelleme (Doğru ama öncelik ayırt etme).' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Karışmam, ebeveynin tercihi.', weights: { clinical: -0.5, ethics: -0.2 }, analysisInsight: 'Sorumsuzluk.' },
        { label: '"Sakın vermeyin, otizm yapar!" diye korkuturum.', weights: { clinical: -0.2, empathy: -0.8 }, analysisInsight: 'Bilimsel Olmayan Korkutma.' },
        { label: 'Uygun bir zamanda, bu eylemin ağlamayı nasıl "ödüllendirdiğini" ve gelecekte ağlama krizlerini artıracağını ABC döngüsüyle açıklarım.', weights: { clinical: 1.0, parentStudentRelations: 0.8 }, analysisInsight: 'Psiko-Eğitim: Ebeveyni suçlamadan mekanizmayı öğretme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Vurana kızılmalı ve mola (time-out) verilmeli.', weights: { pedagogicalAnalysis: -0.2 }, analysisInsight: 'Cezalandırıcı Yaklaşım.' },
        { label: 'Vurulan çocuğa ilgi gösterilmeli (mağdur onarımı) ki vuran çocuk "ilgi çekmek için vurma" davranışının işe yaramadığını görsün.', weights: { pedagogicalAnalysis: 1.0, clinical: 0.9 }, analysisInsight: 'Stratejik İhmal: Zorbalığı beslemeyen sosyal mühendislik.' },
        { label: 'İkisi de ayrılmalı.', weights: { pedagogicalAnalysis: 0.0 }, analysisInsight: 'Nötr.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'İzin vermem, altına yapsa da derste kalacak.', weights: { clinical: -0.5, ethics: -1.0 }, analysisInsight: 'İnsan Hakları İhlali Riski.' },
        { label: 'Her seferinde gönderirim, fizyolojik ihtiyaçtır.', weights: { clinical: -0.5 }, analysisInsight: 'Davranışsal Manipülasyona Teslimiyet.' },
        { label: 'Tuvalete götürürüm ama orada "bekleme süresi" ekleyerek veya tuvaleti "sıkıcı" hale getirerek (nötr kalarak) kaçışın ödül değerini düşürürüm.', weights: { clinical: 1.0 }, analysisInsight: 'Kaçınmayı Söndürme: Fizyolojik ihtiyacı reddetmeden motivasyonu kırma.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Yüz kere yazdırırım.', weights: { pedagogicalAnalysis: -0.5 }, analysisInsight: 'Ezberci Ceza.' },
        { label: 'Görsel ipuçları (Örn: "b" baba, "d" dede göbeği) ve çok duyulu (kumda yazma) yöntemlerle bedensel hafızayı devreye sokarım.', weights: { pedagogicalAnalysis: 1.0 }, analysisInsight: 'Multisensory Öğretim.' },
        { label: 'Daha büyük punto ile yazarım.', weights: { pedagogicalAnalysis: 0.2 }, analysisInsight: 'Yetersiz Uyarlama.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Evet, sonuçta bakıyor.', weights: { clinical: -0.8 }, analysisInsight: 'Klinik Körlük: Koşullu bakışı genellenmiş beceri sanma.' },
        { label: 'Hayır, bu "Pekiştireç Odaklı" bakıştır. Sosyal amaçlı spontane bakış olmadan beceri kazanılmış sayılmaz.', weights: { clinical: 1.0 }, analysisInsight: 'Klinik Doğruluk.' },
        { label: 'Kısmen.', weights: { clinical: 0.0 }, analysisInsight: 'Belirsiz.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Terbiyesiz!" diye bağırıp otorite kurmak.', weights: { pedagogicalAnalysis: -0.8, clinical: -0.5 }, analysisInsight: 'Duygusal Kontrol Kaybı.' },
        { label: 'İğrenmiş bir yüz ifadesiyle silmek.', weights: { pedagogicalAnalysis: -0.4 }, analysisInsight: 'Sosyal Ceza (Bazen işe yarar ama riskli).' },
        { label: 'Tamamen "Poker Face" (Nötr Yüz) kalarak, tükürmenin bende bir duygu (öfke/üzüntü) yaratmadığını gösterip davranışın "güç/kontrol" işlevini boşa çıkarmak.', weights: { pedagogicalAnalysis: 1.0, clinical: 1.0 }, analysisInsight: 'Profesyonel Sönümleme: Davranışı besleyen duygusal yakıtı kesmek.' }
      ]
    },
    // PEDAGOJİK EKLEMELER
    {
      ...
      weightedOptions: [
        { label: 'Sözlük anlamını anlatırım.', weights: { pedagogicalAnalysis: -0.5 }, analysisInsight: 'Soyut Hata: Otizmde sözel açıklama yetersizdir.' },
        { label: 'Sadece emoji kartları gösteririm.', weights: { pedagogicalAnalysis: 0.2 }, analysisInsight: 'Sığ Görselleştirme.' },
        { label: 'O an yaşadığı deneyimle (örn: salıncakta gülerken) "Bak şu an mutlusun" diyerek etiketi o duyguya anlık yapıştırırım (Labeling Live).', weights: { pedagogicalAnalysis: 1.0 }, analysisInsight: 'Deneyimsel Öğretim.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Arabaları saklarım.', weights: { clinical: -0.5 }, analysisInsight: 'Kriz Tetikleme.' },
        { label: 'Takıntısına izin veririm, mutlu olsun.', weights: { clinical: -0.5 }, analysisInsight: 'Amaçsız Vakit Geçirme.' },
        { label: 'Arabaları dizme eylemini dersin içine katarım (Örn: "Kırmızı arabayı diz", "İki araba diz") ve takıntıyı öğretim aracına dönüştürürüm.', weights: { clinical: 1.0, pedagogicalAnalysis: 1.0 }, analysisInsight: 'İlgi Alanını Kullanma (Using Special Interests).' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Zorla oturtup "Kalkmak yasak" diyerek.', weights: { pedagogicalAnalysis: -0.6 }, analysisInsight: 'Fiziksel Zorlama.' },
        { label: 'Önce 1 dakika otur, sonra 5 dakika zıpla (Premack) şeklinde başlayıp, oturma süresini kademeli artırarak (Shaping).', weights: { pedagogicalAnalysis: 1.0, clinical: 0.8 }, analysisInsight: 'Kademeli Şekillendirme.' },
        { label: 'Masa başı çalışmam, hep yerde oynarım.', weights: { pedagogicalAnalysis: 0.0 }, analysisInsight: 'Okula Hazırlık Eksikliği.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Yaparsın aslanım" diye gaz veririm.', weights: { clinical: 0.0 }, analysisInsight: 'Boş Motivasyon.' },
        { label: 'Görevi, çocuğun "Hata yapmasının imkansız olduğu" kadar küçük parçalara bölerek (Errorless Learning) ona başarı hissini tattırırım.', weights: { clinical: 1.0, pedagogicalAnalysis: 1.0 }, analysisInsight: 'Hatasız Öğretim ve Başarı Zinciri.' },
        { label: 'Yapmazsan teneffüs yok derim.', weights: { clinical: -0.8 }, analysisInsight: 'Tehdit.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Diğer çocuklara "Onunla oynayın" diye emrederim.', weights: { pedagogicalAnalysis: -0.5 }, analysisInsight: 'Zoraki Sosyalleşme.' },
        { label: 'Çocuğun en iyi yaptığı şeyi (örn: iyi resim çiziyor) ön plana çıkararak sınıfta "doğal bir hayranlık ve statü" kazanmasını sağlarım.', weights: { pedagogicalAnalysis: 1.0, empathy: 0.8 }, analysisInsight: 'Sosyal Mühendislik ve Güçlendirme.' },
        { label: 'Kendi haline bırakırım.', weights: { pedagogicalAnalysis: -1.0 }, analysisInsight: 'İhmal.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Ben de sarılır öperim, sevgi iyileştirir.', weights: { clinical: -0.5, ethics: -0.3 }, analysisInsight: 'Profesyonel Sınır İhlali.' },
        { label: 'İterim, bana dokunma derim.', weights: { clinical: -1.0, empathy: -1.0 }, analysisInsight: 'Reddedilme Travması.' },
        { label: 'Sarılma ihtiyacını nazikçe "Çak bir beşlik" veya "Tokalaşma" gibi sosyal olarak daha uygun bir selamlaşmaya dönüştürürüm.', weights: { clinical: 1.0, socialSkills: 1.0 }, analysisInsight: 'Sosyal Beceri Öğretimi.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '40 dakika boyunca oturması için zorlarım.', weights: { pedagogicalAnalysis: -0.8 }, analysisInsight: 'İşkence.' },
        { label: 'Dersi "Mikro-Derslere" bölerim. 2 dakika ders, 1 dakika hareket molası şeklinde yoğunlaştırılmış kısa intervaller uygularım.', weights: { pedagogicalAnalysis: 1.0, clinical: 0.9 }, analysisInsight: 'Interval Eğitim ve Dikkat Yönetimi.' },
        { label: 'Sadece oyun oynarım.', weights: { pedagogicalAnalysis: -0.4 }, analysisInsight: 'Hedefsizlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Emin misin?" diye sorarım.', weights: { clinical: 0.2 }, analysisInsight: 'Yetersiz Kontrol.' },
        { label: 'Cevabı "Hayır" olan absürt sorular (Örn: "İnekler uçar mı?") sorarak otomatikleştirdiği "Evet" cevabını kırmasını sağlarım.', weights: { clinical: 1.0, pedagogicalAnalysis: 0.8 }, analysisInsight: 'Çeldirici Soru Tekniği.' },
        { label: 'Kızarım.', weights: { clinical: -0.5 }, analysisInsight: 'Gereksiz.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Materyali kaldırırım.', weights: { pedagogicalAnalysis: -0.5 }, analysisInsight: 'Fırsatı Kaçırma.' },
        { label: 'Elini tutup (Fiziksel İpucu) doğru yapmasını sağlar, yapar yapmaz ödüllendiririm.', weights: { pedagogicalAnalysis: 1.0 }, analysisInsight: 'Hata Düzeltme (Correction) ve İpucu.' },
        { label: 'Sözlü olarak uyarırım.', weights: { pedagogicalAnalysis: 0.0 }, analysisInsight: 'Etkisiz Uyaran.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Konuşur merak etmeyin" derim.', weights: { clinical: -0.5, ethics: -0.5 }, analysisInsight: 'Yalan.' },
        { label: 'Alıcı dil deposu dolmadan ifade edici dilin başlamayacağını, şu an "Sözcük dağarcığını" doldurduğumuzu, konuşmanın bunun doğal sonucu olacağını anlatırım.', weights: { clinical: 1.0, parentStudentRelations: 1.0 }, analysisInsight: 'Gelişimsel Süreç Bilgilendirmesi.' },
        { label: 'Çocuğu konuşmaya zorlarım.', weights: { clinical: -0.8 }, analysisInsight: 'Travma Riski.' }
      ]
    }
  ],
  ...
  ethics_parent: [
    {
      ...
      weightedOptions: [
        { label: 'Veririm, sağlık söz konusu, o an kural düşünülmez.', weights: { workEthics: -0.5, empathy: 0.8, institutionalLoyalty: -0.6 }, analysisInsight: 'Sınır İhlali (Boundary Violation): İyi niyetli ama yönetilemez bir iletişim kapısı açma ve kurumsal protokolü delme riski.' },
        { label: 'Numaramı vermem, kurumsal hattan atmasını isterim. O an atamıyorsa "Sakin olun, sabah ilk iş izleyeceğim" derim.', weights: { workEthics: 1.0, institutionalLoyalty: 1.0, empathy: 0.3 }, analysisInsight: 'Profesyonel Sınır: Kriz anında bile kurumsal kanalı koruma ve veliyi regüle etme.' },
        { label: 'Numaramı veririm ama "Sakın beni aramayın, sadece videoyu atın ve sonra silin" derim.', weights: { workEthics: -0.3, sustainability: -0.5 }, analysisInsight: 'Naiflik: Sınırın delineceğini öngörememe ve gizli anlaşma yapma.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Müdürüm ne diyorsa doğrudur, ben yorum yapamam." derim.', weights: { workEthics: -0.6, institutionalLoyalty: 0.4, personality: -0.4 }, analysisInsight: 'Bürokratik Sığınma: Pasif suç ortaklığı ve mesleki kimliksizlik.' },
        { label: '"Hayır, çocuğunuz hiç ilerlemiyor, sizi oyalıyorlar." derim.', weights: { institutionalLoyalty: -1.0, workEthics: 0.3, personality: -0.6 }, analysisInsight: 'Kurumsal Sabotaj: Doğruyu söylerken kurumu yıkma (Yıkıcı Dürüstlük) ve ekip içi güveni bitirme.' },
        { label: '"Bazı alanlarda güzel çabaları var ancak X ve Y konularında (yerinde saydığı alanlar) daha yoğun çalışmamız ve strateji değiştirmemiz gerekiyor." diyerek gerçeği yumuşatmadan ama profesyonelce sunarım.', weights: { workEthics: 1.0, parentStudentRelations: 1.0, institutionalLoyalty: 0.6 }, analysisInsight: 'Diplomatik Dürüstlük: Kurumu korurken gerçeği manipüle etmeme, veliyi bilgilendirme ve çözüm odaklılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Veliye inandığımı söylerim, aile işine karışmak haddim değil.', weights: { workEthics: -1.0, clinical: -0.8 }, analysisInsight: 'İhmal: Çocuğun güvenliğini riske atma ve yasal sorumluluğu yok sayma.' },
        { label: 'Hemen polisi veya sosyal hizmetleri ararım.', weights: { workEthics: 0.6, institutionalLoyalty: -0.4, sustainability: -0.3 }, analysisInsight: 'Dürtüsel Eylem: Kurumsal protokolü ve silsileyi atlayarak kriz yaratma riski.' },
        { label: 'Vücut haritasına (Body Chart) morluğu işler, tutanak tutar ve derhal Kurum Müdürü/Psikoloğu ile "Kritik Vaka Toplantısı" talep ederim.', weights: { workEthics: 1.0, institutionalLoyalty: 1.0, clinical: 0.9 }, analysisInsight: 'Prosedürel Yetkinlik: Yasal ve kurumsal silsileyi doğru işletme, veriyi kaydetme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Tabii ki olur, o çok zeki bir çocuk, merak etmeyin, zamanla hepsi düzelecek." (Yalan bile olsa).', weights: { workEthics: -0.5, parentStudentRelations: 0.4 }, analysisInsight: 'Pembe Tablo: Etik olmayan sahte umut satışı ve profesyonel olmayan güvence.' },
        { label: '"Geleceği bilemeyiz, biz işimizi yapıyoruz." (Kaçamak).', weights: { parentStudentRelations: -0.3, personality: -0.2 }, analysisInsight: 'Soğukluk: Veliyi duygusal boşlukta bırakma ve empatik bağ kuramama.' },
        { label: '"Potansiyeli var ancak bu bir maraton. Biz şu anki hedefimiz olan X becerisine odaklanalım, orayı aştıkça önümüzü daha net göreceğiz." (Realist & Yönlendirici).', weights: { parentStudentRelations: 1.0, workEthics: 1.0, clinical: 0.6 }, analysisInsight: 'Profesyonel Umut: Gerçekçi, sürece odaklayan, ne aşırı vaat veren ne de umut kıran dengeli liderlik.' }
      ]
    },
    // YENİ EKLENEN: İŞ ETİĞİ & SINIR (10 SORU)
    {
      ...
      weightedOptions: [
        { label: 'Alırım, sonuçta çok emek veriyorum ve maaşım düşük.', weights: { workEthics: -1.0, integrity: -1.0 }, analysisInsight: 'Rüşvet/Etik İhlal.' },
        { label: 'Nazikçe reddederim, "Benim ödülüm çocuğun başarısıdır, kurum prensipleri gereği alamam" derim.', weights: { workEthics: 1.0, institutionalLoyalty: 1.0 }, analysisInsight: 'Etik Duruş.' },
        { label: 'Alırım ama "Aramızda kalsın" derim.', weights: { workEthics: -1.0 }, analysisInsight: 'Gizli İttifak.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'İsteği kabul ederim, DM\'den cevap yazarım.', weights: { workEthics: -0.5, boundary: -0.5 }, analysisInsight: 'Sosyal Sınır İhlali.' },
        { label: 'İsteği reddederim, videoyu görmezden gelirim.', weights: { parentStudentRelations: -0.3 }, analysisInsight: 'İletişim Kopukluğu.' },
        { label: 'Sosyal medyadan eklemem (mesafeyi korurum) ama DM\'e resmi bir dille "Videoyu kurumsal hattımızdan atarsanız dosrasına ekleyip inceleyebilirim" yazarım.', weights: { workEthics: 1.0, boundary: 1.0 }, analysisInsight: 'Profesyonel Kanal Yönetimi.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Tamam, babaya bilgi vermem" derim.', weights: { workEthics: -0.5, legal: -0.8 }, analysisInsight: 'Yasal Risk: Ortak velayette iki tarafın da bilgi alma hakkı vardır.' },
        { label: 'Kurum müdürüne ve avukatına danışmadan karar vermem, mahkeme kararını (velayet belgesini) isterim. Resmi belge gelene kadar standart prosedürü uygularım.', weights: { workEthics: 1.0, legal: 1.0 }, analysisInsight: 'Yasal Prosedüre Uygunluk.' },
        { label: 'Anneyi desteklerim, üzgün görünüyor.', weights: { workEthics: -0.2, empathy: 0.5 }, analysisInsight: 'Duygusal Tarafgirlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Giderim, aile gibi olduk.', weights: { workEthics: -0.4, boundary: -0.6 }, analysisInsight: 'Çoklu İlişki Riski (Dual Relationship).' },
        { label: 'Gitmem ama çiçek veya tebrik kartı göndererek nazikçe mesafemi korurum.', weights: { workEthics: 1.0, socialSkills: 0.8 }, analysisInsight: 'Sosyal Nezaket ve Sınır.' },
        { label: 'Gitmem, işim olmaz.', weights: { parentStudentRelations: -0.5 }, analysisInsight: 'Kabalık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Kabul ederim, ek gelir olur.', weights: { workEthics: -1.0, institutionalLoyalty: -1.0 }, analysisInsight: 'Etik Dışı / Sadakatsizlik.' },
        { label: '"Kurumda çalışmam daha verimli oluyor" diyerek geçiştiririm.', weights: { institutionalLoyalty: 0.2 }, analysisInsight: 'Yetersiz Red.' },
        { label: 'Kurum sözleşmem gereği dışarıda ders veremeyeceğimi net bir dille belirtir ve durumu yönetime raporlarım.', weights: { workEthics: 1.0, institutionalLoyalty: 1.0 }, analysisInsight: 'Tam Etik Sadakat.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Evet, maalesef biraz tecrübesiz" diyerek onaylarım.', weights: { workEthics: -0.8, team: -1.0 }, analysisInsight: 'Meslektaşı Satış / Dedikoduya İştirak.' },
        { label: 'Sessiz kalırım.', weights: { workEthics: 0.0 }, analysisInsight: 'Pasif Onay.' },
        { label: '"Meslektaşım hakkında konuşmam etik değil, dilerseniz endişelerinizi idare ile görüşebilirsiniz" diyerek konuyu kapatırım.', weights: { workEthics: 1.0, team: 1.0 }, analysisInsight: 'Mesleki Dayanışma ve Sınır.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Söylemem, boşuna panik yapmasınlar.', weights: { workEthics: -1.0, trust: -1.0 }, analysisInsight: 'Güven İhlali ve Risk Gizleme.' },
        { label: 'Sadece müdüre söylerim.', weights: { workEthics: 0.5 }, analysisInsight: 'Yarım Sorumluluk.' },
        { label: 'Dürüstçe veliyi arar, hatamı kabul eder ve çocuğu gözlemlemesi için uyarırım. Güven, dürüstlükle inşa edilir.', weights: { workEthics: 1.0, integrity: 1.0 }, analysisInsight: 'Radikal Dürüstlük ve Sorumluluk.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Tamamlarım, dışarıdaki beklesin.', weights: { workEthics: -0.5, justice: -1.0 }, analysisInsight: 'Diğer Öğrencinin Hakkını Gasp.' },
        { label: '"Maalesef süreniz doldu" der kestirip atarım.', weights: { parentStudentRelations: -0.5 }, analysisInsight: 'Empatisiz Red.' },
        { label: 'Kalan süreyi en verimli şekilde kullanırım ama seansı vaktinde bitiririm. "Diğer öğrencinin hakkına giremem, telafi için başka bir boşluk bakalım" derim.', weights: { workEthics: 1.0, justice: 1.0 }, analysisInsight: 'Adaletli Sınır Yönetimi.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Gizlice kullanmam.', weights: { institutionalLoyalty: -0.2, transparency: -0.5 }, analysisInsight: 'Gizli İsyankar.' },
        { label: 'Kullanırım, emir demiri keser.', weights: { clinical: -0.5 }, analysisInsight: 'Sorgusuz İtaat.' },
        { label: 'Bilimsel dayanaklarıyla (makale vs.) yönetime sunum yapar ve bu materyalin neden değiştirilmesi gerektiğini savunurum.', weights: { workEthics: 1.0, initiative: 1.0 }, analysisInsight: 'Yapıcı Eleştiri ve Gelişim.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Tabii ki, çok akıllı çocuk" derim.', weights: { ethics: -0.8 }, analysisInsight: 'Umut Tacirliği.' },
        { label: '"Zor, bence gidemez" derim.', weights: { empathy: -0.8 }, analysisInsight: 'Yıkıcı Gerçekçilik.' },
        { label: '"Şu anki hedefimiz bağımsız yaşam becerileri. Geleceği bugünkü çalışmalarımız şekillendirecek, adım adım gidelim" diyerek odağı bugüne çekerim.', weights: { ethics: 1.0, communication: 1.0 }, analysisInsight: 'Profesyonel Gerçekçilik ve Süreç Odaklılık.' }
      ]
    }
  ],
  ...
  resilience_team: [
    {
      ...
      weightedOptions: [
        { label: 'Onu hemen müdüre şikayet ederim, işini düzgün yapsın.', weights: { sustainability: 0.3, fit: -0.6 }, analysisInsight: 'İspiyonculuk/Çatışma: Takım içi güveni zedeleme ve sorunu birebir çözme yetisinden yoksunluk.' },
        { label: 'Küserek konuşmam, trip atarım, anlasın.', weights: { sustainability: -0.6, personality: -0.7 }, analysisInsight: 'Pasif Agresyon: Profesyonellik dışı çocuksu tepki.' },
        { label: 'Onu kenara çeker, "Geç kalman benim planımı bozuyor ve beni zor durumda bırakıyor, buna bir çözüm bulalım" diyerek "Ben Dili" ile konuşurum.', weights: { sustainability: 1.0, fit: 1.0, personality: 0.9 }, analysisInsight: 'Olgun İletişim (Assertiveness): Sorunu kaynağında, çatışma yaratmadan ve yönetimi meşgul etmeden çözme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Öfkelenirim ve "Terbiyesiz, bir daha yapma!" diye bağırırım.', weights: { sustainability: -1.0, clinical: -1.0 }, analysisInsight: 'Duygusal Çöküş: Davranışı kişiselleştirme ve profesyonel maskeyi düşürme.' },
        { label: 'Çok üzülürüm, demek ki ben başarısızım, bana saygısı yok diye düşünürüm.', weights: { sustainability: -0.6, personality: -0.4 }, analysisInsight: 'Kırılganlık: Özgüven kaybı ve tükenmişlik sinyali.' },
        { label: 'Duygusal olarak etkilenmemeye çalışırım. "Bu bir davranış, şahsıma değil" derim ve ABC kaydına "Saldırganlık" olarak nötr şekilde işlerim.', weights: { sustainability: 1.0, clinical: 1.0, workEthics: 0.8 }, analysisInsight: 'Profesyonel Zırh (Depersonalization): Davranışı klinik bir veri olarak görme ve soğukkanlılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Gitmem, işim daha önemli, sosyalleşmek zorunda değilim.', weights: { institutionalLoyalty: 0.3, fit: -0.5 }, analysisInsight: 'Sosyal İzolasyon: Takım ruhunu önemsememe ve yabancılaşma.' },
        { label: 'İşleri bırakır tüm gün kutlamada otururum, ayıp olmasın.', weights: { workEthics: -0.4, fit: 0.3 }, analysisInsight: 'İş Disiplini Zafiyeti: Sosyal onayı işin önüne koyma.' },
        { label: '5-10 dakika uğrar, görünür, tebrik eder ve "Yetiştirmem gereken raporlar var, size iyi eğlenceler" diyerek nazikçe ayrılırım.', weights: { institutionalLoyalty: 1.0, fit: 1.0, sustainability: 0.7 }, analysisInsight: 'Sosyal Zeka ve Denge: Hem takıma aidiyet gösterme hem de sorumluluğu yerine getirme.' }
      ]
    },
    // YENİ EKLENEN: RESİLİANS (DİRENÇ) (10 SORU)
    {
      ...
      weightedOptions: [
        { label: 'Çocuğa "Bugün uslu dur, başım ağrıyor" derim.', weights: { sustainability: -0.5 }, analysisInsight: 'Profesyonellik Dışı: Kendi sorununu çocuğa yükleme.' },
        { label: 'Enerjimi toplamak için bir kahve içer, "Sahneye Çıkış" moduna geçerim. Benim yorgunluğum çocuğun eğitim hakkını etkilememeli.', weights: { sustainability: 1.0, workEthics: 1.0 }, analysisInsight: 'Profesyonel Dayanıklılık (Professional Stamina).' },
        { label: 'Çocuğu serbest bırakır, dinlenirim.', weights: { sustainability: -1.0, workEthics: -1.0 }, analysisInsight: 'Mesleki Tükenmişlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Moralim bozulur, ağlarım veya küserim.', weights: { sustainability: -0.5, personality: -0.5 }, analysisInsight: 'Duygusal Kırılganlık.' },
        { label: 'Sinirlenirim, "Siz daha iyisini yapın o zaman" derim.', weights: { sustainability: -0.5, fit: -0.8 }, analysisInsight: 'Eleştiriye Kapalılık.' },
        { label: 'Eleştiriyi şahsıma değil işime yapılmış sayarım. "Neleri düzeltmemi önerirsiniz?" diye sorarak geri bildirimi gelişim fırsatına çeviririm.', weights: { sustainability: 1.0, developmentOpenness: 1.0 }, analysisInsight: 'Gelişim Odaklılık (Growth Mindset).' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Ben yetersizim" diye düşünür, mesleği sorgularım.', weights: { sustainability: -0.5 }, analysisInsight: 'Yetersizlik Hissi.' },
        { label: '"Çocukta iş yok" derim.', weights: { sustainability: -0.2, empathy: -0.5 }, analysisInsight: 'Suçu Dışsallaştırma.' },
        { label: 'Yöntemimi sorgularım. "Demek ki bu yol çalışmıyor, başka ne deneyebilirim?" diyerek süpervizörden destek isterim.', weights: { sustainability: 1.0, problemSolving: 1.0 }, analysisInsight: 'Çözüm Odaklı Direnç.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Onun açıklarını ben kapatırım, idare ederim.', weights: { sustainability: 0.5, boundary: -0.5 }, analysisInsight: 'Kurtarıcı Rolü (Sürdürülemez).' },
        { label: 'Yönetime şikayet ederim.', weights: { fit: -0.5 }, analysisInsight: 'Destek Eksikliği.' },
        { label: 'Onunla konuşur, destek olabileceğimi ama işlerin aksadığını, gerekirse izin alması gerektiğini dostça belirtirim.', weights: { fit: 1.0, sustainability: 1.0 }, analysisInsight: 'Dengeli Takım Arkadaşlığı.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Bu iş yapılmaz, delireceğim."', weights: { sustainability: -1.0 }, analysisInsight: 'Tükenmişlik Sinyali.' },
        { label: '"Neden ben? Hep bana zor çocuklar veriyorlar."', weights: { sustainability: -0.5 }, analysisInsight: 'Kurban Psikolojisi.' },
        { label: '"Bugün zordu. Yarın güvenlik önlemlerimi artırmalı ve davranış planını gözden geçirmeliyim." der, işi kapıda bırakır dinlenirim.', weights: { sustainability: 1.0, selfRegulation: 1.0 }, analysisInsight: 'Psikolojik Sağlamlık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Hemen dedikoduya başlar, "Batıyoruz galiba" derim.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Kaos Yaratma.' },
        { label: 'Motivasyonum düşer, derslere isteksiz girerim.', weights: { workEthics: -0.5 }, analysisInsight: 'Profesyonellik Kaybı.' },
        { label: 'Sakin kalırım, yönetime durumu sorarım ama işime yansıtmam. Profesyonellik bunu gerektirir.', weights: { sustainability: 1.0, institutionalLoyalty: 0.8 }, analysisInsight: 'Olgunluk.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Küserim, bir daha fikir sunmam.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'Pasif Agresyon.' },
        { label: 'Projeyi daha düşük maliyetle nasıl yapabileceğimi araştırır, tekrar sunarım.', weights: { sustainability: 1.0, creativity: 1.0 }, analysisInsight: 'Azim ve Yaratıcılık.' },
        { label: 'Başka kurumlara fikrimi satmaya çalışırım.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Sadakatsizlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Ben de ona bağırırım, kendimi ezdirmem.', weights: { sustainability: -1.0, professionalDistance: -1.0 }, analysisInsight: 'Öfke Kontrolsüzlüğü.' },
        { label: 'Ağlayarak odayı terk ederim.', weights: { sustainability: -0.5 }, analysisInsight: 'Yetersiz Kriz Yönetimi.' },
        { label: 'Sakinliğimi korur, "Şu an gerginsiniz, sakinleşince konuşalım" diyerek sınırı çizer ve tartışmaya girmem.', weights: { sustainability: 1.0, professionalDistance: 1.0 }, analysisInsight: 'Profesyonel Soğukkanlılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Rapor alır gelmem.', weights: { workEthics: -1.0 }, analysisInsight: 'İş Ahlakı Sorunu.' },
        { label: 'İstifa tehdidi savururum.', weights: { sustainability: -0.5 }, analysisInsight: 'Dürtüsellik.' },
        { label: 'Durumu anlarım ama telafisinin ne zaman olacağını netleştiririm. Kurumu yarı yolda bırakmam.', weights: { sustainability: 1.0, institutionalLoyalty: 1.0 }, analysisInsight: 'Sorumluluk Bilinci.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Bana ceza verdiler" diye düşünürüm.', weights: { sustainability: -0.5 }, analysisInsight: 'Negatif Bakış.' },
        { label: '"Herkesin yanıldığını kanıtlayacağım" diyerek hırslanırım.', weights: { sustainability: 0.8, motivation: 1.0 }, analysisInsight: 'Meydan Okuma (Challenge) Motivasyonu.' },
        { label: 'Ben de uğraşmam, vakit doldururum.', weights: { workEthics: -1.0 }, analysisInsight: 'Mesleki İhanet.' }
      ]
    }
  ],
  ...
  vision_loyalty: [
    {
      ...
      weightedOptions: [
        { label: 'Asla imzalamam, özgürlüğüm kısıtlanamaz, ben eğitimi kendim alırım.', weights: { institutionalLoyalty: -0.6, developmentOpenness: 0.2 }, analysisInsight: 'Bağlılık Sorunu: Yatırıma ve uzun vadeli işbirliğine kapalı profil.' },
        { label: 'İmzalarım ama daha iyi teklif gelirse tazminatı öder kaçarım.', weights: { institutionalLoyalty: -0.8, workEthics: -0.6 }, analysisInsight: 'Etik Risk: Güvenilmez ve fırsatçı profil.' },
        { label: 'Memnuniyetle imzalarım. Kurumun bana yatırım yapması, bana değer verdiğini gösterir ve kariyerim için bir fırsattır.', weights: { institutionalLoyalty: 1.0, developmentOpenness: 1.0 }, analysisInsight: 'Kariyer Ortaklığı: Kurumla büyüme vizyonu ve karşılıklı güven.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Eski usül kağıt kalem daha iyiydi, ne gerek var bu kadar teknolojiye?" diye direnç gösteririm.', weights: { developmentOpenness: -0.7, institutionalLoyalty: -0.3 }, analysisInsight: 'Değişim Direnci (Resistance to Change): Statükocu ve yeniliğe kapalı.' },
        { label: '"Tamam" derim ama kullanmam, başkasına yaptırırım veya eksik yaparım.', weights: { workEthics: -0.6, developmentOpenness: -0.4 }, analysisInsight: 'Pasif Direniş: Sinsi uyumsuzluk.' },
        { label: 'Zor olsa da öğrenmek için ekstra mesai harcarım. Teknoloji mesleğimizin geleceğidir ve buna adapte olmalıyım.', weights: { developmentOpenness: 1.0, sustainability: 0.6 }, analysisInsight: 'Gelişim Zihniyeti (Growth Mindset): Yeniliğe adaptasyon ve öğrenme hevesi.' }
      ]
    },
    // YENİ EKLENEN: KURUMSAL SADAKAT & GELİŞİME AÇIKLIK (10+10 = 20 SORU)
    {
      ...
      weightedOptions: [
        { label: 'Hemen kabul eder, istifa ederim. Profesyonellik paradır.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Fırsatçı (Mercenary) Profil.' },
        { label: 'Teklifi mevcut kurumumla paylaşır, "Bakın bana ne veriyorlar" diye pazarlık yaparım.', weights: { institutionalLoyalty: -0.5, negotiation: 0.5 }, analysisInsight: 'Riskli Pazarlık.' },
        { label: 'Mevcut kurumumdaki huzurum, ekibim ve manevi tatminim %20 farktan daha değerliyse reddederim. Sadakat sadece para değildir.', weights: { institutionalLoyalty: 1.0 }, analysisInsight: 'Derin Bağlılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Ben böyle alıştım, sonuç da alıyorum" der, değişmem.', weights: { developmentOpenness: -0.8 }, analysisInsight: 'Mesleki Tutuculuk.' },
        { label: '"Tamam" derim ama o gidince bildiğimi okurum.', weights: { integrity: -0.5, developmentOpenness: -0.5 }, analysisInsight: 'Gizli Direniş.' },
        { label: 'Konfor alanımdan çıkmak zor olsa da yeni yöntemi denerim. Bilim sürekli güncelleniyor, ben de güncellenmeliyim.', weights: { developmentOpenness: 1.0 }, analysisInsight: 'Öğrenme Çevikliği (Learning Agility).' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Ekstra para almadan yapmam, görev tanımımda yok" derim.', weights: { institutionalLoyalty: -0.5 }, analysisInsight: 'Sadece Görev Odaklı (Jobsworth).' },
        { label: 'Yaparım, bu hem kurumun hem de benim kişisel markamın tanınması için bir fırsattır.', weights: { institutionalLoyalty: 1.0, branding: 1.0 }, analysisInsight: 'Kazan-Kazan Vizyonu.' },
        { label: 'Baştan savma bir şey yaparım.', weights: { workEthics: -0.5 }, analysisInsight: 'Kalitesizlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Gitmem, hafta sonu benim dinlenme zamanım.', weights: { developmentOpenness: -0.2 }, analysisInsight: 'Düşük Kariyer Hırsı.' },
        { label: 'Kurum öderse giderim, yoksa gitmem.', weights: { developmentOpenness: 0.2, passive: 0.5 }, analysisInsight: 'Dışsal Motivasyonlu.' },
        { label: 'Kendi cebimden öder giderim. Bilgiye yapılan yatırım en büyük yatırımdır.', weights: { developmentOpenness: 1.0, ambition: 1.0 }, analysisInsight: 'İçsel Motivasyon ve Kariyer Yatırımı.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Ben de dedikoduya katılır, "Burası batıyor" derim.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Toksik Etki.' },
        { label: 'Sessizce CV\'mi güncellerim.', weights: { institutionalLoyalty: 0.0 }, analysisInsight: 'Sessiz Terk (Quiet Quitting).' },
        { label: 'Dedikodulara kulak tıkar, işime odaklanırım. Kurumun bana ihtiyacı varken gemiyi terk etmem.', weights: { institutionalLoyalty: 1.0, resilience: 0.8 }, analysisInsight: 'Krizde Sadakat.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'İngilizcem yok, yapamam.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'Öğrenilmiş Çaresizlik.' },
        { label: 'Translate kullanarak da olsa o makaleyi çözerim. Dil bariyeri beni durduramaz.', weights: { developmentOpenness: 1.0, resourcefulness: 1.0 }, analysisInsight: 'Kaynak Yaratıcılığı.' },
        { label: 'Başkasına yaptırırım.', weights: { workEthics: -0.2 }, analysisInsight: 'Hazırcılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Hemen kabul ederim, öğrenci getirmiş olurum.', weights: { ethics: -0.2 }, analysisInsight: 'Etik Gri Alan (Eski kurumla sözleşmeye bağlı).' },
        { label: 'Memnuniyetle yönlendiririm, bu benim değil kurumumun kalitesinin bir sonucudur.', weights: { institutionalLoyalty: 1.0 }, analysisInsight: 'Marka Değeri Transferi.' },
        { label: '"Gelmeyin, burası da kötü" derim.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Kurumu Kötüleme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Reddederim, yapamam.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'Fırsat Tepme.' },
        { label: 'Hasta numarası yaparım.', weights: { integrity: -0.8 }, analysisInsight: 'Kaçış.' },
        { label: 'Korksam da kabul ederim. Bu korkuyu yenmek için bir fırsattır.', weights: { developmentOpenness: 1.0, courage: 1.0 }, analysisInsight: 'Cesaret ve Gelişim.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Evet, reklam olur.', weights: { integrity: -0.8, institutionalLoyalty: -0.5 }, analysisInsight: 'Fikri Mülkiyet İhlali.' },
        { label: 'Hayır, bu kurumun malıdır. Paylaşırsam kurumu etiketleyerek paylaşırım.', weights: { institutionalLoyalty: 1.0, integrity: 1.0 }, analysisInsight: 'Etik Sahiplenme.' },
        { label: 'Kimse anlamazsa paylaşırım.', weights: { integrity: -1.0 }, analysisInsight: 'Karakter Zafiyeti.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Kendi yerimi açmış olurum.', weights: { institutionalLoyalty: 0.2, ambition: 1.0 }, analysisInsight: 'Girişimci (Kurum için riskli olabilir ama vizyoner).' },
        { label: 'Bu kurumda yönetici veya koordinatör olarak daha fazla sorumluluk almış halde.', weights: { institutionalLoyalty: 1.0, stability: 1.0 }, analysisInsight: 'İçeride Büyüme (Intrapreneur).' },
        { label: 'Bilmiyorum, akışına bıraktım.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'Vizyonsuzluk.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Her yerde kötülerim.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'Marka Zararı.' },
        { label: 'Umursamam, işime bakarım.', weights: { institutionalLoyalty: 0.0 }, analysisInsight: 'Nötr.' },
        { label: 'Daha iyi bir öneriyle yönetime giderim, kurumsal kimliğe katkı sağlamaya çalışırım.', weights: { institutionalLoyalty: 1.0, creativity: 0.8 }, analysisInsight: 'Sahiplenme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Hayır, benim alanım değil.', weights: { developmentOpenness: -0.3 }, analysisInsight: 'Dar Bakış Açısı.' },
        { label: 'Katılırım, bir gün lazım olabilir. Bilgi bilgidir.', weights: { developmentOpenness: 1.0 }, analysisInsight: 'Çok Yönlülük.' },
        { label: 'Zorunluysa gider uyurum.', weights: { workEthics: -0.5 }, analysisInsight: 'Zaman Kaybı.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Hayır, mesaim bitti.', weights: { institutionalLoyalty: -0.2 }, analysisInsight: 'Memur Zihniyeti.' },
        { label: 'Gönüllü olarak katılır ve destek olurum. Kurum kültürü mesai ile sınırlı değildir.', weights: { institutionalLoyalty: 1.0, team: 1.0 }, analysisInsight: 'Kurumsal Vatandaşlık.' },
        { label: 'Ek mesai ücreti verirlerse gelirim.', weights: { institutionalLoyalty: 0.0 }, analysisInsight: 'Parasal Odak.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Sen daha dünküsün" diye bozarım.', weights: { developmentOpenness: -1.0, ego: -1.0 }, analysisInsight: 'Egoist Kapalılık.' },
        { label: 'Önerisini denerim, iyiyse kullanır ve ona teşekkür ederim. Akıl yaşta değil baştadır.', weights: { developmentOpenness: 1.0, humility: 1.0 }, analysisInsight: 'Alçakgönüllü Öğrenme.' },
        { label: 'Dinlemem.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'İletişimsizlik.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: '"Burası böyle maalesef" der yangına körükle giderim.', weights: { institutionalLoyalty: -1.0 }, analysisInsight: 'İçeriden Yıkım.' },
        { label: 'Beni ilgilendirmez, yönetim halletsin.', weights: { institutionalLoyalty: 0.0 }, analysisInsight: 'Pasiflik.' },
        { label: 'Sorunu dinler, çözebileceğim bir şeyse çözer, değilse yönetime köprü olurum. Her öğrenci kaybı benim de kaybımdır.', weights: { institutionalLoyalty: 1.0, problemSolving: 1.0 }, analysisInsight: 'Marka Elçiliği.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Üniversitede okumuştum.', weights: { developmentOpenness: -0.8 }, analysisInsight: 'Akademik Paslanma.' },
        { label: 'Geçen ay. Sürekli okurum.', weights: { developmentOpenness: 1.0 }, analysisInsight: 'Aktif Gelişim.' },
        { label: 'Kitap okumam, internetten bakarım.', weights: { developmentOpenness: 0.2 }, analysisInsight: 'Yüzeysel Bilgi.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Dersi yapmam, temizlenmesini beklerim.', weights: { flexibility: -0.5 }, analysisInsight: 'Katılık.' },
        { label: 'Müdüre bağırırım.', weights: { fit: -0.8 }, analysisInsight: 'Agresyon.' },
        { label: 'Hemen bir süpürge alıp kabaca temizler dersime başlarım. Çocuğun eğitimi, benim "temizlik yapmamamdan" daha önemlidir.', weights: { institutionalLoyalty: 1.0, humility: 1.0 }, analysisInsight: 'Egosuz Sahiplenme.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Her şeye inanırım.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'Saflık.' },
        { label: 'Duyduğum her bilgiyi sorgular, kaynağına bakarım.', weights: { developmentOpenness: 1.0, analytical: 1.0 }, analysisInsight: 'Bilimsel Şüphecilik.' },
        { label: 'Sadece kendi bildiğime inanırım.', weights: { developmentOpenness: -0.8 }, analysisInsight: 'Bilişsel Kapalılık.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Kabul etmem, sorumluluk alamam.', weights: { institutionalLoyalty: 0.0 }, analysisInsight: 'Riskten Kaçınma.' },
        { label: 'Kabul ederim, bu güvene layık olmaya çalışırım.', weights: { institutionalLoyalty: 1.0, integrity: 1.0 }, analysisInsight: 'Yüksek Güvenilirlik.' },
        { label: 'Kabul ederim (aklımda başka şeyler var).', weights: { integrity: -1.0 }, analysisInsight: 'Tehlike.' }
      ]
    },
    {
      ...
      weightedOptions: [
        { label: 'Evet, çok sıkıcı.', weights: { developmentOpenness: -0.5 }, analysisInsight: 'İlgisizlik.' },
        { label: 'Hayır, not alarak izlerim.', weights: { developmentOpenness: 1.0 }, analysisInsight: 'Tutku.' },
        { label: 'Bazen.', weights: { developmentOpenness: 0.0 }, analysisInsight: 'Ortalama İlgi.' }
      ]
    }
  ]
};
