    ...
    <div className="flex flex-col h-full bg-white relative">
      ...
      <div className="bg-slate-50 border-b border-slate-200 px-6 py-2 flex gap-4 overflow-x-auto no-scrollbar shrink-0">
         {[
           ...
           { id: 'dna', label: 'SPEKTRUM & DNA', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' }, 
            ...
            <div className="space-y-10 max-w-6xl mx-auto animate-fade-in pb-32">
               ...
               {activeTab === 'predictions' && (
                  <div className="space-y-10 animate-fade-in">
                     ...
                     {/* 1. LAYER: NÖRAL BÜYÜME Forecast (GRAFİK) */}
                     <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                     ...
                     {/* 2. LAYER: FAZ BAZLI EVRİM TİMELİNE */}
                     ...
                     {/* 3. LAYER: RİSK YÖNETİMİ & PROAKTİF KORUMA */}
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* KRİTİK RİSK KARTI */}
                        <div className="bg-rose-50 p-12 rounded-[4rem] border border-rose-100 shadow-sm relative overflow-hidden group">
                           <div className="relative z-10">
                              ...
                              <h5 className="text-[11px] font-black text-rose-900 uppercase tracking-[0.4em] mb-3">TESPİT EDİLEN TÜKENMİŞLİK RİSKİ</h5>
                              <p className="text-2xl font-black text-rose-950 leading-[1.1] uppercase tracking-tighter mb-4">
                                 "{candidate.report.predictiveMetrics?.riskMitigation?.primaryRisk}"
                              </p>
                              <p className="text-[11px] font-bold text-rose-800/60 uppercase tracking-widest leading-relaxed">
                                 AI, adayın 'Duygusal Dayanıklılık' ve 'Kriz Refleksi' mülakat verilerini sentezleyerek bu potansiyel bariyeri saptamıştır.
                              </p>
                           </div>
                        ...
                        <div className="bg-emerald-50 p-12 rounded-[4rem] border border-emerald-100 shadow-sm relative overflow-hidden">
                           <div className="relative z-10">
                              ...
                              <p className="text-[17px] font-bold text-emerald-950 leading-relaxed italic text-justify">
                                 "{candidate.report.predictiveMetrics?.riskMitigation?.preventionStrategy}"
                              </p>
                              <div className="mt-8 flex gap-3">
                                 <span className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-[9px] font-black uppercase tracking-widest">PROAKTİF</span>
                                 <span className="px-4 py-2 bg-white text-emerald-600 border border-emerald-200 rounded-xl text-[9px] font-black uppercase tracking-widest">SİSTEMİK</span>
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div className="space-y-6 relative z-10">
                              {(candidate.report.interviewGuidance?.criticalObservations || []).map((obs, i) => (
                                 <div key={i} className="flex gap-6 items-start">
                                    ...
                                    <p className="text-[15px] font-bold text-slate-200 uppercase tracking-tight leading-relaxed italic text-justify">{obs}</p>
                                 </div>
                              ))}
                           </div>
