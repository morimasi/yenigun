  ...
  const GROUPS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'admin', label: 'ADMIN PANELİ', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' }
      ]
    }
  ];
    ...
    <div className="flex items-center justify-between h-full px-6 bg-white text-slate-600 font-sans" ref={navRef}>
      ...
      <div className="flex items-center gap-3 pl-6 border-l border-slate-200 ml-6 shrink-0 h-8">
        ...
        <button
          ...
          className="w-10 h-10 rounded-xl flex items-center justify-center bg-white border border-slate-200 text-slate-400 hover:bg-slate-50 hover:text-orange-600 hover:border-orange-200 transition-all disabled:opacity-50 shadow-sm"
        >
