  ...
  const ALL_GROUPS = [
    {
      ...
      items: [
        { id: 'pipeline', label: 'Başvuru Havuzu', roles: [StaffRole.Admin], icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 005.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
        ...
        { id: 'comm', label: 'İletişim Merkezi', roles: [StaffRole.Admin, StaffRole.Mentor], icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
      ]
    },
    {
      id: 'analysis',
      ...
      items: [
        { id: 'decision', label: 'Karar Destek (AI)', roles: [StaffRole.Admin], icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
        { id: 'analytics', label: 'Genel İstatistik', roles: [StaffRole.Admin, StaffRole.Mentor], icon: 'M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z' },
      ]
    },
    {
      id: 'academy',
      ...
      items: [
        { id: 'training', label: 'Hizmet İçi Eğitim', roles: [StaffRole.Admin, StaffRole.Mentor, StaffRole.Staff], icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
        { id: 'arms', label: 'Personel Dosyaları', roles: [StaffRole.Admin, StaffRole.Mentor], icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 005.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z' },
        { id: 'methodology', label: 'Soru Envanteri', roles: [StaffRole.Admin], icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 012-2h2a2 2 0 012 2' },
    ...
    },
    {
      ...
      items: [
        { id: 'settings', label: 'Parametreler', roles: [StaffRole.Admin], icon: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4' }
      ]
    }
  ];
      ...
      <div className="flex items-center gap-4 shrink-0 mr-8">
        ...
        <div className="hidden xl:block">
           ...
           <div className="flex items-center gap-1.5 mt-0.5">
             ...
             <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{user?.name} | {userRole.toUpperCase()}</span>
           </div>
        </div>
      </div>
                     ...
                     return (
                       ...
                       >
                          ...
                          <div>
                             ...
                             <span className={`text-[9px] font-bold uppercase tracking-widest ${isActive ? 'text-white/60' : 'text-slate-300'}`}>Erişim Aktif</span>
                          </div>
                       </button>
                     );
                   })}
