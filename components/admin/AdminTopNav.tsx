...
const AdminTopNav: React.FC<AdminTopNavProps> = ({ 
  ...
  const GROUPS = [
    ...
    },
    {
      id: 'analysis',
      label: 'ANALİZ',
      icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', // Analytics Icon
      items: [
    ...
    },
    {
      id: 'memory',
      label: 'KURUMSAL',
      icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', // Office Icon
      items: [
        { id: 'arms', label: 'Personel & Mentor', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
    ...
    },
    {
      id: 'sys',
      label: 'SİSTEM',
      icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 00-2.573 1.066c-1.543.94-3.31.826-4.74 0a1.724 1.724 0 00-2.573-1.066c.426 1.756 2.924 1.756 3.35 0', // Cog Icon
      items: [
      ...
      <div className="flex items-center gap-4 shrink-0 mr-8">
        ...
        <div className="hidden xl:block">
           ...
           <div className="flex items-center gap-1.5 mt-0.5">
             ...
             <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">SİSTEM AKTİF v5.2</span>
           </div>
        </div>
      </div>

      {/* DROPDOWN NAVIGATION (INTELLIGENT GROUPS) */}
