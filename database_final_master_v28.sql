...
-- VERSİYON: 28.0 (PLATINUM PRODUCTION RELEASE)
-- KAPSAM: RECRUITMENT, ARMS (HRMS), LMS HUB, CLINICAL LAB, SIGNAL HUB
-- ============================================================================
...
-- [A] Global Sistem Konfigürasyonu (MIA AI Çekirdek)
...
-- [B] Sistem Bildirimleri (Admin Sinyal Merkezi - Real Time)
...
CREATE TABLE IF NOT EXISTS candidates (
    ...
    archive_category TEXT,             -- CANDIDATE_POOL, HIRED_CONTRACTED, DISQUALIFIED, BLACK_LIST
    archive_note TEXT,
    admin_notes TEXT,
...
CREATE TABLE IF NOT EXISTS staff_idp (
    id TEXT PRIMARY KEY,               -- 'IDP-XXXX' (TEXT tabanlı mühür)
    staff_id TEXT REFERENCES staff(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS clinical_simulations (
    ...
    result_data JSONB NOT NULL,        -- AI Projeksiyonu, Bilişsel Sapma Verileri
    stress_level INTEGER NOT NULL,
    is_sealed BOOLEAN DEFAULT FALSE,   -- Mühürlenmiş döküman
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
);
...
-- JSONB Hızlandırıcılar (GIN Index) - AI Taramaları için kritik
...
-- Global Config v28 (MIA Çekirdek Parametreleri)
...
VALUES ('SYSTEM_ALERT', 'SUCCESS', 'V28.0 Platinum Mühürlendi', 'Master veritabanı tüm akademik ve operasyonel modülleri kapsayacak şekilde başarıyla güncellendi.')
ON CONFLICT DO NOTHING;

-- ============================================================================
-- SON: MASTER SCHEMA v28.0 KURULUMU TAMAMLANDI.
-- ============================================================================
