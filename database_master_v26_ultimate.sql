...
-- VERSİYON: 26.0 (CONSOLIDATED PRODUCTION RELEASE - MASTER)
-- MODÜLLER: MIA AI, ARMS, CLINICAL LAB, LMS HUB, COMM CENTER, SIGNALS
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS staff (
    ...
    department TEXT,
    experience_years INTEGER DEFAULT 0,
    last_score INTEGER DEFAULT 0,      -- En son sınav başarısı (Kritik Alan)
...
VALUES ('SYSTEM_ALERT', 'SUCCESS', 'V26.0 Ultimate Master Devreye Alındı', 'Kurumsal veritabanı mimarisi en üst segment güvenlik ve performans standartlarıyla mühürlendi.')
ON CONFLICT DO NOTHING;

-- ============================================================================
-- SON: MASTER SCHEMA v26.0 KURULUMU TAMAMLANDI.
-- ============================================================================
